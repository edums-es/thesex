...
<html data-lang="{$system['language']['code']}" {if $system['language']['dir'] == "RTL"} dir="RTL" {/if}>
  ...
  <head>
    ...
    {/if}
    <link href="{$system['system_url']}/content/themes/{$system['theme']}/css/monetization.css?v={$system['system_version']}-{filemtime('content/themes/xngine/css/monetization.css')}" rel="stylesheet">
    <link href="{$system['system_url']}/content/themes/{$system['theme']}/css/creator-experience.css?v={$system['system_version']}-{filemtime('content/themes/xngine/css/creator-experience.css')}" rel="stylesheet">
    <!-- CSS -->
