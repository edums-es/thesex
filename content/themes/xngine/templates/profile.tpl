		...
		<div class="position-sticky x_top_posts profile-tabs-wrapper {if $profile['is_creator_profile']}creator-profile-tabs{/if}">
			<div class="d-flex align-items-center justify-content-center">
				...
				{if $profile['can_write_blogs']}
					<div {if $view == "blogs"}class="active fw-semibold" {/if}>
						<a href="{$system['system_url']}/{$profile['user_name']}/blogs" class="body-color side_item_hover w-100 text-center d-block">
