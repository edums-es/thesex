						...
						<div class="flex-1">
							...
							<div class="publisher-message position-relative">
								<div class="colored-text-wrapper">
									<div class="quill-editor js_quill mt-2 w-100 p-0 border-0 bg-transparent"></div>
									<input type="hidden" class="js_publisher-hidden-editor" value="">
									<textarea style="display: none;" {if $_modal_mode}autofocus{/if} dir="auto" class="js_autosize js_mentions js_publisher-scraper mt-2 w-100 p-0 border-0 bg-transparent" data-init-placeholder='{__("What is on your mind?")}' placeholder='{__("What is on your mind?")}'>{if $url}{$url}{/if}</textarea>
								</div>
							</div>
							<!-- publisher-message -->
						...
						<div class="flex-1">
							...
							<div class="publisher-slider">
								<div class="d-flex align-items-center flex-wrap justify-content-between gap-10 side_item_list">
									...
									<div class="d-flex align-items-center flex-wrap publisher-tools-tabs">
										{if !$_quick_mode}
											{if $system['ai_images_enabled']}
												<div class="publisher-tools-tab js_publisher-tab main position-relative rounded-circle main_bg_half p-2 pointer" data-tab="ai_image" data-toggle="modal" data-size="large" data-url="ai/modal.php?handle=image" title='{__("Generate Image")}'>
													<svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="7" cy="8" r="1.5" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"/><path d="M20.9977 11C21 11.4701 21 11.9693 21 12.5C21 16.9783 21 19.2175 19.6088 20.6088C18.2175 22 15.9783 22 11.5 22C7.02166 22 4.78249 22 3.39124 20.6088C2 19.2175 2 16.9783 2 12.5C2 8.02166 2 5.78249 3.39124 4.39124C4.78249 3 7.02166 3 11.5 3C12.0307 3 12.5299 3 13 3.00231" stroke="currentColor" stroke-width="1.75" stroke-linecap="round"/><path d="M18.5 2L18.7579 2.69703C19.0961 3.61102 19.2652 4.06802 19.5986 4.40139C19.932 4.73477 20.389 4.90387 21.303 5.24208L22 5.5L21.303 5.75792C20.389 6.09613 19.932 6.26524 19.5986 6.59861C19.2652 6.93198 19.0961 7.38898 18.7579 8.30297L18.5 9L18.2421 8.30297C17.9039 7.38898 17.7348 6.93198 17.4014 6.59861C17.068 6.26524 16.611 6.09613 15.697 5.75792L15 5.5L15.697 5.24208C16.611 4.90387 17.068 4.73477 17.4014 4.40139C17.7348 4.06802 17.9039 3.61102 18.2421 2.69703L18.5 2Z" stroke="currentColor" stroke-width="1.75" stroke-linejoin="round"/><path d="M4.5 21.4999C8.87246 16.275 13.7741 9.384 20.9975 14.0424" stroke="currentColor" stroke-width="1.75"/></svg>
												</div>
											{/if}
											{if $system['ai_posts_enabled']}
												<div class="publisher-tools-tab js_publisher-tab main position-relative rounded-circle main_bg_half p-2 pointer" data-tab="ai" data-toggle="modal" data-size="large" data-url="ai/modal.php?handle=post" title='{__("Generate Post")}'>
													<svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M11 21H10C6.22876 21 4.34315 21 3.17157 19.8284C2 18.6569 2 16.7712 2 13V10C2 6.22876 2 4.34315 3.17157 3.17157C4.34315 2 6.22876 2 10 2H12C15.7712 2 17.6569 2 18.8284 3.17157C20 4.34315 20 6.22876 20 10V10.5" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"/><path d="M17.4069 14.4036C17.6192 13.8655 18.3808 13.8655 18.5931 14.4036L18.6298 14.4969C19.1482 15.8113 20.1887 16.8518 21.5031 17.3702L21.5964 17.4069C22.1345 17.6192 22.1345 18.3808 21.5964 18.5931L21.5031 18.6298C20.1887 19.1482 19.1482 20.1887 18.6298 21.5031L18.5931 21.5964C18.3808 22.1345 17.6192 22.1345 17.4069 21.5964L17.3702 21.5031C16.8518 20.1887 15.8113 19.1482 14.4969 18.6298L14.4036 18.5931C13.8655 18.3808 13.8655 17.6192 14.4036 17.4069L14.4969 17.3702C15.8113 16.8518 16.8518 15.8113 17.3702 14.4969L17.4069 14.4036Z" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"/><path d="M7 7H15M7 11.5H15M7 16H11" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"/></svg>
												</div>
											{/if}
										{/if}
									...
									<div class="d-flex align-items-center flex-0 publisher-tools-tabs d-none">
									...
									<div class="collapse" id="x_pub_options">
										<div class="publisher-footer-options">
											...
											{if $_handle == "me" && $user->_data['can_add_anonymous_posts']}
												<div class="form-table-row mb-2 pb-1" id="anonymous-toggle-wrapper">
													<div>
											...
											{if in_array($_handle, ['me', 'group','event']) && $user->_data['can_add_collaborative_posts']}
												<div class="form-table-row mb-2 pb-1" id="collaborative-toggle-wrapper">
													<div>
							...
							<div class="d-flex align-items-center justify-content-between publisher-footer side_item_list pb-0 flex-wrap">
								<div class="d-flex align-items-center publisher-tools-tabs">
									{if $system['photos_enabled']}
										<div class="publisher-tools-tab attach overflow-hidden js_publisher-tab js_publisher-images-uploader main position-relative rounded-circle main_bg_half p-2 pointer" data-tab="photos" data-bs-toggle="tooltip" title='{__("Upload Photos")}'>
