        ...
        <div class="float-end">
          ...
          <a href="#" data-bs-toggle="dropdown" class="countries-filter">
            ...
            {elseif $sort == "salary-high"}
              <i class="fas fa-sort-amount-down fa-fw"></i><span class="d-none d-md-inline-block ml5">{__("Salary High")}</span>
            {elseif $sort == "salary-low"}
              <i class="fas fa-sort-amount-down-alt fa-fw"></i><span class="d-none d-md-inline-block ml5">{__("Salary Low")}</span>
            {/if}
          </a>
