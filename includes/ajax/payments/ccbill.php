...
/**
 * ajax -> payments -> ccbill [Pre-Payment Integration]
 * 
 * @package Sngine
 * @author Zamblek
 */
...
try {
  ...
  switch ($_POST['handle']) {
    case 'packages':
      ...
      // get ccbill link
      $link = ccbill("packages", $package['price'], $package['package_id']);
      break;
    ...
    case 'wallet':
      ...
      // store amount in session for webhook to use
      $_SESSION['wallet_replenish_amount'] = $_POST['price'];

      // get ccbill link
      $link = ccbill("wallet", $_POST['price']);
      break;
    ...
    case 'donate':
      ...
      // get ccbill link
      $link = ccbill("donate", $_POST['price'], $_POST['post_id']);
      break;
    ...
    case 'subscribe':
      ...
      // get ccbill link
      $link = ccbill("subscribe", $monetization_plan['price'], $_POST['plan_id']);
      break;
    ...
    case 'paid_post':
      ...
      // get ccbill link
      $link = ccbill("paid_post", $post['post_price'], $_POST['post_id']);
      break;
    ...
    case 'movies':
      ...
      // get ccbill link
      $link = ccbill("movies", $movie['price'], $_POST['movie_id']);
      break;
    ...
    case 'marketplace':
      ...
      // get ccbill link
      $link = ccbill("marketplace", $orders_collection['total'], $_POST['orders_collection_id']);
      break;
